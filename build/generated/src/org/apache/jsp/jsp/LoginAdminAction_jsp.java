...
public final class LoginAdminAction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
out.println("connected");
      ...
      out.write("        ");
       ...
       //Statement st1=con.createStatement();
        ResultSet  rs=st.executeQuery("select * from supermarket.adminlogin where username='" + aname +"'");
 ...
 response.sendRedirect("../progs/UserHome.html");
             ...
             response.sendRedirect("../progs/failure.html");
