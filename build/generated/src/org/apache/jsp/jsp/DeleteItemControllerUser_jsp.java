...
public final class DeleteItemControllerUser_jsp extends org.apache.jasper.runtime.HttpJspBase
...
out.println("connected\n");
      ...
      // Statement st1=con.createStatement();
       ...
       PreparedStatement ps = con.prepareStatement("delete from supermarket.items where itemid="+ id1 +" ");
      // ps.setString(1,id);
...
if(i > 0)
{
      out.write('\n');
      if (true) {
        _jspx_page_context.forward("./SuccessDelete.jsp");
        return;
      }
      out.write('\n');
      ...
      out.write('\n');
      if (true) {
        _jspx_page_context.forward("./failureDelete.jsp");
        return;
      }
      out.write('\n');
